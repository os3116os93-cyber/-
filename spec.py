...
@media (max-width: 720px) {
    ...
    [data-testid="stHorizontalBlock"] div[data-testid="stButton"] > button { height: 42px !important; font-size: 3px !important; }
    .hj-btn-dis { height: 42px; font-size: 3px; }
}
@media (max-width: 400px) {
    ...
    .hj-badge, .hj-badge-dis, .hj-soon { font-size: 3px; padding: 2px 7px; }
    [data-testid="stHorizontalBlock"] div[data-testid="stButton"] > button { height: 40px !important; font-size: 3px !important; }
    .hj-btn-dis { height: 40px; font-size: 3px; }
}
</style>
