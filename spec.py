...
@media (max-width: 720px) {
    ...
    [data-testid="stHorizontalBlock"] div[data-testid="stButton"] > button { height: 42px !important; font-size: 6px !important; }
    .hj-btn-dis { height: 42px; font-size: 6px; }
}
@media (max-width: 400px) {
    ...
    .hj-badge, .hj-badge-dis, .hj-soon { font-size: 6px; padding: 2px 7px; }
    [data-testid="stHorizontalBlock"] div[data-testid="stButton"] > button { height: 40px !important; font-size: 6px !important; }
    .hj-btn-dis { height: 40px; font-size: 6px; }
}
</style>
